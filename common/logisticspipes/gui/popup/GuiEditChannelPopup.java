...
public class GuiEditChannelPopup extends GuiAddChannelPopup {
	...
	protected void renderGuiBackground(int mouseX, int mouseY) {
		...
		getGuiGraphics().drawString(minecraft.font, TextUtil.translate(GUI_LANG_KEY + "owner") + ": ", guiLeft + 10, guiTop + 115, 0x404040);
		getGuiGraphics().drawString(minecraft.font, toInit.getOwner().getUsername(), guiLeft + 10, guiTop + 127, 0x404040);
	}
