...
public final class LineTubeRenderer implements ISpecialPipeRenderer, IHighlightPlacementRenderer {
	...
	private static final ResourceLocation TEXTURE = LPConstants.rl("textures/blocks/pipes/hs-tube-line.png");

	public static void loadModels() {
		try {
			Map<String, IModel3D> pipePartModels = SimpleServiceLocator.cclProxy.parseObjModels(
          LogisticsPipes.class.getResourceAsStream("/models/HSTube-Line_result.obj"), 7, new LPScale(1 / 100f));
