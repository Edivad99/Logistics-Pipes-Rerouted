...
public class ChassisPipeScreen extends LogisticsBaseGuiScreen<ChassisMenu> {
    ...
    public void init() {
        ...
        for (int i = 0; i < chassisPipe.getChassisSize(); i++) {
            ...
            if (hasUpgradeModuleUpgrade) {
                ...
                upA.setPressListener(b -> ClientPacketDistributor.sendToServer(
                    new OpenUpgradeConfigMessage(upgradeSlots.get(idxA).index)));
                ...
                upB.setPressListener(b -> ClientPacketDistributor.sendToServer(
                    new OpenUpgradeConfigMessage(upgradeSlots.get(idxB).index)));
    ...
    protected void extractGuiBackground(GuiGraphicsExtractor guiGraphics, int x, int y, float f) {
        ...
        LPGuiGraphics.drawPlayerInventoryBackground(guiGraphics, leftPos + 18,
            topPos + 9 + 20 * chassisPipe.getChassisSize());
