...
public class InvSysConnectorScreen extends LogisticsBaseGuiScreen<InvSysConMenu> implements IGUIChannelInformationReceiver {
	...
	public void init() {
		...
		SmallGuiButton b2 = new SmallGuiButton(2, leftPos + 68, topPos + 67, 46, 10, TextUtil.translate(InvSysConnectorScreen.PREFIX + "Refresh"));
		...
		SmallGuiButton b5 = new SmallGuiButton(5, leftPos + 140, topPos + 55, 30, 10, TextUtil.translate(InvSysConnectorScreen.PREFIX + "Save"));
		...
		SmallGuiButton b6 = new SmallGuiButton(6, leftPos + 130, topPos + 20, 40, 10, TextUtil.translate(InvSysConnectorScreen.PREFIX + "Change"));
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.text(minecraft.font, TextUtil.translate(InvSysConnectorScreen.PREFIX + "InventorySystemConnector"), 5, 6, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(InvSysConnectorScreen.PREFIX + "ConnectionInformation") + ":", 10, 21, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.getTrimmedString(TextUtil.translate(InvSysConnectorScreen.PREFIX + "Channel") + ": " + (connectedChannel != null ? connectedChannel.getName() : "UNDEFINED"), 150, this.font, "..."), 15, 38, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(InvSysConnectorScreen.PREFIX + "Resistance") + ":", 10, 55, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(InvSysConnectorScreen.PREFIX + "Waitingfor") + ":", 10, 68, 0xFF404040, false);
