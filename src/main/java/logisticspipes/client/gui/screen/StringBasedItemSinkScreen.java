...
public class StringBasedItemSinkScreen extends ModuleBaseScreen<ModuleAnalysisMenu> {
    ...
    public StringBasedItemSinkScreen(ModuleAnalysisMenu menu, Inventory inventory, Component title) {
    ...
    protected void extractGuiBackground(GuiGraphicsExtractor guiGraphics, int var2, int var3, float var1) {
        ...
        SimpleGraphics.drawRectNoBlend(guiGraphics, leftPos + 26, topPos + 5, leftPos + 169, topPos + 17,
            Color.DARK_GREY, 0.0);
