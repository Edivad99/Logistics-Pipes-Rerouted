...
public class FluidSupplierMk2PipeScreen extends LogisticsBaseGuiScreen<FluidSupplierMk2Menu> {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(minecraft.font, TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "TargetInv"), panelWidth / 2 - minecraft.font.width(TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "TargetInv")) / 2, 6, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "Inventory"), 15, panelHeight - 95, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "Fluid") + ":", 25, 22, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "Partial") + ":", panelWidth - 176, panelHeight - 109, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "minMode") + ":", panelWidth - 108, panelHeight - 109, 0xFF404040, false);
	...
	public void init() {
		super.init();
		SmallGuiButton partialsBtn = new SmallGuiButton(0, width / 2 - 48, topPos + panelHeight - 115, 30, 20, logic.isRequestingPartials() ? TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "Yes") : TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "No"));
		partialsBtn.setPressListener(b -> {
			logic.setRequestingPartials(!logic.isRequestingPartials());
			b.setMessage(Component.literal(logic.isRequestingPartials() ? TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "Yes") : TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + "No")));
			ClientPacketDistributor.sendToServer(
					new FluidSupplierPartialsMessage(logic.getPos(), logic.isRequestingPartials()));
		});
		addRenderableWidget(partialsBtn);
		SmallGuiButton minModeBtn = new SmallGuiButton(1, width / 2 + 30, topPos + panelHeight - 115, 55, 20, TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + logic.getMinMode().name()));
		minModeBtn.setPressListener(b -> {
			...
			b.setMessage(Component.literal(TextUtil.translate(FluidSupplierMk2PipeScreen.PREFIX + logic.getMinMode().name())));
