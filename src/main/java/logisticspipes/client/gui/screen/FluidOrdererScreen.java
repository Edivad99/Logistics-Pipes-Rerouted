...
public class FluidOrdererScreen extends OrdererScreen<FluidOrdererMenu> {

    public FluidOrdererScreen(FluidOrdererMenu menu, Inventory inventory, Component title) {
    ...
    public void init() {
        ...
        if (setItemDisplay) {
            itemDisplay = new ItemDisplay(this, font, this, this, leftPos + 10, topPos + 18, panelWidth - 20,
                panelHeight - 100, xCenter, bottom - 24, 49, new int[] { 1, 1000, 16000, 100 }, false);
        }
