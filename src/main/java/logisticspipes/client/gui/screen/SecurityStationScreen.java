...
public class SecurityStationScreen extends LogisticsBaseGuiScreen<SecurityStationMenu> implements PlayerListReciver {
	...
	public void init() {
		...
		btnOpen = new SmallGuiButton(4, leftPos + 241, topPos + 217, 30, 10, TextUtil.translate(SecurityStationScreen.PREFIX + "Open"));
		...
		btnEditTable = new SmallGuiButton(6, leftPos + 162, topPos + 60, 60, 10, TextUtil.translate(SecurityStationScreen.PREFIX + "EditTable"));
		...
		btnAuthorize = new SmallGuiButton(7, leftPos + 55, topPos + 95, 70, 20, TextUtil.translate(SecurityStationScreen.PREFIX + "Authorize"));
		...
		btnDeauthorize = new SmallGuiButton(8, leftPos + 175, topPos + 95, 70, 20, TextUtil.translate(SecurityStationScreen.PREFIX + "Deauthorize"));
		...
		btnChannelManager = new SmallGuiButton(10, leftPos + 177, topPos + 230, 95, 20, TextUtil.translate(SecurityStationScreen.PREFIX + "ChannelManager"));
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.text(font, TextUtil.translate(SecurityStationScreen.PREFIX + "SecurityStation"), 105, 10, 0xFF404040, false);
		guiGraphics.text(font, tile.getSecId() == null ? "null" : tile.getSecId().toString(), 32, 25, 0xFF404040, false);
		if (LogisticsPipes.isDEBUG()) {
			guiGraphics.text(font, TextUtil.translate(SecurityStationScreen.PREFIX + "allowCCAccess") + ":", 10, 46, 0xFF404040, false);
			guiGraphics.text(font, TextUtil.translate(SecurityStationScreen.PREFIX + "excludeIDs") + ":", 10, 61, 0xFF404040, false);
		}
		guiGraphics.text(font, TextUtil.translate(SecurityStationScreen.PREFIX + "pipeRemove") + ":", 10, 78, 0xFF404040, false);
		guiGraphics.text(font, TextUtil.translate(SecurityStationScreen.PREFIX + "Player") + ":", 180, 127, 0xFF404040, false);
		guiGraphics.text(font, TextUtil.translate(SecurityStationScreen.PREFIX + "SecurityCards") + ":", 10, 127, 0xFF404040, false);
		guiGraphics.text(font, TextUtil.translate(SecurityStationScreen.PREFIX + "Inventory") + ":", 10, 163, 0xFF404040, false);
