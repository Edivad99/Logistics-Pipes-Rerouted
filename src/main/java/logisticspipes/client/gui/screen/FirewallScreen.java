...
public class FirewallScreen extends LogisticsBaseGuiScreen<FirewallMenu> {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.text(minecraft.font, TextUtil.translate(FirewallScreen.PREFIX + "Firewall"), 45, 8, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FirewallScreen.PREFIX + "Filter") + ":", 14, 28, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FirewallScreen.PREFIX + "Filtereditemsare") + ":", 125, 8, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FirewallScreen.PREFIX + "Providing") + ":", 144, 41, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FirewallScreen.PREFIX + "Crafting") + ":", 146, 74, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FirewallScreen.PREFIX + "Sorting") + ":", 150, 107, 0xFF404040, false);
		guiGraphics.text(minecraft.font, TextUtil.translate(FirewallScreen.PREFIX + "Powerflow") + ":", 142, 141, 0xFF404040, false);
	}
}
