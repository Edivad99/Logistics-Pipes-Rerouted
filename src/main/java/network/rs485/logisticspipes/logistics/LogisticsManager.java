...
/** Finds the routers that will take an item, best offer first. */
public final class LogisticsManager {
     ...
     */
    public Iterator<Destination> allDestinations(ItemStack stack, ItemIdentifier itemid, boolean canBeDefault,
    ...
    public @Nullable Destination getDestination(ItemStack stack, ItemIdentifier itemid, boolean canBeDefault,
    ...
    private @Nullable Destination getBestReply(ItemStack stack, ItemIdentifier itemid, ServerRouter sourceRouter,
